...
public class ThirdFile extends AppCompatActivity {
        ...
        btn_close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Intent intent = new Intent(ThirdFile.this, MainActivity.class);
...
//подключаем анимацию
        final Animation a = AnimationUtils.loadAnimation(ThirdFile.this, R.anim.alpha);
